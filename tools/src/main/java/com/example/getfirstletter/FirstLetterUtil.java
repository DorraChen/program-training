...
public class FirstLetterUtil {
    ...
    public static String getFirstLetter(String sourceStr) {
        ...
        try {
            result += char2Initial(char2Initial(str.charAt(0)));
        } catch (Exception e) {
            result = "";
        }
        return result;
...
//        System.out.println(getFirstLetter("北京市"));
//        System.out.println(getFirstLetter("哈尔滨"));
//        System.out.println(getFirstLetter("天津市"));
//        System.out.println(getFirstLetter("吉林市"));

        // todo 多音字需要特殊处理
        System.out.println(getFirstLetter("重庆市"));
    }
}
