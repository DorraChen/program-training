...
public class Pinyin4jUtil {
    ...
    public static void main(String[] args) {
        System.out.println("小写输出：" + getPinyinToLowerCase("重庆市"));
        System.out.println("大写输出：" + getPinyinToUpperCase("重庆市"));
        System.out.println("首字母大写输出：" + getPinyinFirstToUpperCase("重庆市"));
        System.out.println("简拼输出：" + getPinyinJianPin("重庆市"));
        // =============================================================================
        System.out.println("小写输出：" + getPinyinToLowerCase("张三"));
        System.out.println("大写输出：" + getPinyinToUpperCase("张三"));
        System.out.println("首字母大写输出：" + getPinyinFirstToUpperCase("张三"));
        System.out.println("简拼输出：" + getPinyinJianPin("张三"));
        // =============================================================================
        System.out.println("小写输出：" + getPinyinToLowerCase("都是"));
